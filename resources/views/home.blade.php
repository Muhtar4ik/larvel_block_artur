    ...
    <div class="main-banner header-text">
        <div class="container-fluid">
            <div class="owl-banner owl-carousel">
                <div class="item">
                    <img src="/public/assets/images/banner-item-01.jpg" alt="" />
                ...
                <div class="item">
                    <img src="/public/assets/images/banner-item-02.jpg" alt="" />
                    <div class="item-content">
                        <div class="main-content">
                            <div class="meta-category">
                                <span>Nature</span>
                ...
                <div class="item">
                    <img src="/public/assets/images/banner-item-03.jpg" alt="" />
                    <div class="item-content">
                        <div class="main-content">
                            <div class="meta-category">
                                <span>Lifestyle</span>
                ...
                <div class="item">
                    <img src="/public/assets/images/banner-item-04.jpg" alt="" />
                    <div class="item-content">
                        <div class="main-content">
                            <div class="meta-category">
                                <span>Fashion</span>
                ...
                <div class="item">
                    <img src="/public/assets/images/banner-item-05.jpg" alt="" />
                    <div class="item-content">
                        <div class="main-content">
                            <div class="meta-category">
                                <span>Nature</span>
                ...
                <div class="item">
                    <img src="/public/assets/images/banner-item-06.jpg" alt="" />
                    <div class="item-content">
                        <div class="main-content">
                            <div class="meta-category">
                                <span>Lifestyle</span>
                                ...
                                <div class="col-lg-12">
                                    <div class="blog-post">
                                        <div class="blog-thumb">
                                            <img src="/public/assets/images/blog-post-01.jpg" alt="" />
                                        </div>
                                    ...
                                    <div class="content">
                                        <ul>
                                            <li>
                                                <a href="post-details.html">
                                                    <h5>
                                                        Vestibulum id turpis
                                                        porttitor sapien facilisis
                                                        scelerisque
                                                    </h5>
                                            ...
                                            <li>
                                                <a href="post-details.html">
                                                    <h5>
                                                        Suspendisse et metus nec
                                                        libero ultrices varius eget
                                                        in risus
                                                    </h5>
                                            ...
                                            <li>
                                                <a href="post-details.html">
                                                    <h5>
                                                        Swag hella echo park
                                                        leggings, shaman cornhole
                                                        ethical coloring
                                                    </h5>
